...
### 상대방 숫자 생성
-[X] 상대방의 수인 1부터 9사이의 서로 다른 숫자 3개를 생성하여 리스트에 저장한다.

### 게임 플레이어 숫자 처리
-[X] 상대방의 수와 게임 플레이어의 수를 비교하여 결과를 저장한다.

### 입출력
-[X] 게임 플레이어로부터 숫자를 입력받는다.
-[X] 3자리 숫자인지 확인하고 만약 3자리 숫자가 아니라면 Exception을 발생시킨다.
-[X] 게임 플레이어에게 숫자 입력을 받는 메세지를 출력한다.
-[X] 저장한 결과를 바탕으로 결과를 출력한다.
-[X] 게임 종료 조건 달성 시 종료 메세지를 출력한다.
-[X] 게임 지속 여부를 메세지를 출력하고 의사를 입력받는다.
